...
void loop() {
  ...
  //////////////////////Partial refresh time demo/////////////////////////////////////
      ...
      for(i=0;i<6;i++)
      EPD_Dis_Part_Time(32,60+32*0,Num[i],         //x-A,y-A,DATA-A
                        32,60+32*1,Num[0],         //x-B,y-B,DATA-B
                        32,60+32*2,gImage_numdot, //x-C,y-C,DATA-C
                        32,60+32*3,Num[0],        //x-D,y-D,DATA-D
                        32,60+32*4,Num[1],32,64); //x-E,y-E,DATA-E,Resolution 32*64
